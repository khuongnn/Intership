...
\begin{tabular}{|l|l|} 
\hline
\textbf{Module}       & \textbf{Accuracy}                   \\ 
\hline
Wi-Fi Fingerprinting  & 82.33\%~\pm ~ 3.07\%~  \\ 
\hline
Dead Reckoning Model  & 3.88m ~\pm ~ 0.37m~  \\ 
\hline
Propagation Model     & 5.91m~\pm ~ 1.61m~  \\ 
\hline
Extended Kalman Filte & 10.22m~\pm ~ 0.91m~  \\
\hline
\end{tabular}
\end{table}
